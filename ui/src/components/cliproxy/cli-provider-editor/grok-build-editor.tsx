/**
 * Grok Build Tool Editor Component
 * Split-view editor for Grok Build CLI tool provider settings
 */
...
import { useGrokBuildEditor } from './use-grok-build-editor';
...
function GrokBuildModelConfigTab({
  currentModel,
  subagentModel,
  providerModels,
  catalog,
...
export function GrokBuildEditor({
  provider,
  toolId,
  displayName,
  authStatus,
...
export { useGrokBuildEditor } from './use-grok-build-editor';
