...
public partial class SettingsWindow : Window
{
    ...
    void Hydrate()
    {
        ...
        AppearanceBox.SelectedIndex = (int)ui.Appearance; IconBox.SelectedIndex = (int)ui.IconStyle; GlanceBox.SelectedIndex = (int)ui.GlanceMode; PeriodBox.SelectedIndex = (int)ui.SpendPeriod;
    ...
    void Save()
    {
        ...
        var ui = settings.Ui with { Appearance = (BarAppearance)AppearanceBox.SelectedIndex, IconStyle = (BarIconStyle)Math.Max(0, IconBox.SelectedIndex), GlanceMode = (BarGlanceMode)Math.Max(0, GlanceBox.SelectedIndex), SpendPeriod = (SpendPeriod)Math.Max(0, PeriodBox.SelectedIndex), AlertsExpanded = AlertsExpanded.IsChecked == true, AutoCheckUpdates = AutoUpdates.IsChecked == true };
