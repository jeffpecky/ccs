    ...
    if (yamlExists) {
      ...
      try {
        ...
        results.addCheck(
          ...
          `Backup and recreate: mv ${configYamlPath} ${configYamlPath}.backup && npm install -g @jeffpecky/ccs --force`,
    ...
    if (jsonExists) {
      ...
      try {
        ...
        results.addCheck(
          ...
          `Backup and recreate: mv ${configJsonPath} ${configJsonPath}.backup && npm install -g @jeffpecky/ccs --force`,
